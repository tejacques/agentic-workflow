...
Use the context-fetcher subagent to read @docs/product/mission-lite.md and @docs/product/tech-stack.md only if not already in context to ensure minimal context for spec alignment.
...
Use the file-creator subagent to create directory: .agentic-workflow/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file: .agentic-workflow/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: .agentic-workflow/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  <header>
    ...
    This is the technical specification for the spec detailed in @.agentic-workflow/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.agentic-workflow/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<file_template>
  <header>
    ...
    This is the API specification for the spec detailed in @.agentic-workflow/specs/YYYY-MM-DD-spec-name/spec.md
  </header>
</file_template>
...
<review_request>
  ...
  - Spec Requirements: @.agentic-workflow/specs/YYYY-MM-DD-spec-name/spec.md
  - Spec Summary: @.agentic-workflow/specs/YYYY-MM-DD-spec-name/spec-lite.md
  - Technical Spec: @.agentic-workflow/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
