...
# Analyze Current Product & Install Agentic Project Workflow

## Overview

Install Agentic Project Workflow into an existing codebase, analyze current product state and progress.  Builds on plan-product.md
...
<context_questions>
  ...
  To properly set up Agentic Project Workflow, I need to understand:
...
Execute our standard flow for installing Agentic Project Workflow in existing products
...
<execution_prompt>
  ...
  I'm installing Agentic Project Workflow into an existing product. Here's what I've gathered:
...
Verify installation completeness and provide clear next steps for the user to start using Agentic Project Workflow with their existing codebase.
...
<summary_template>
  ## ✅ Agentic Project Workflow Successfully Installed

  I've analyzed your [PRODUCT_TYPE] codebase and set up Agentic Project Workflow with documentation that reflects your actual implementation.
  ...
  4. Start using Agentic Project Workflow for your next feature:
     ```
     @.agentic-workflow/instructions/core/create-spec.md
     ```

  Your codebase is now Agentic Project Workflow-enabled! 🚀
</summary_template>
